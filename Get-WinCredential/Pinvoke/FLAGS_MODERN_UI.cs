...
namespace GetWinCredential.Pinvoke
{
    internal static partial class CREDUI
    {
        ...
        internal enum FLAGS_MODERN_UI
        {
            ...
            ///     password in plain text. This value cannot be combined with SECURE_PROMPT.
            /// </summary>
            ...
            ///     the authPackage parameter should be enumerated. This value cannot be combined
            ///     with CREDUIWIN_IN_CRED_ONLY.
            /// </summary>
            ...
            ///     enumerated. If this flag is set, and the InAuthBuffer parameter is NULL, the
            ///     function fails. This value cannot be combined with CREDUIWIN_AUTHPACKAGE_ONLY.
            /// </summary>
            CREDUIWIN_IN_CRED_ONLY = 0x20,

            /// <summary>
            ///     Credential providers should enumerate only administrators. This value is
            ///     intended for User Account Control (UAC) purposes only. We recommend that
            ...
            ///     cannot be combined with CREDUIWIN_GENERIC. Windows Vista: This value is not
            ...
            ///     refOutAuthBuffer parameter to a 32-bit boundary, even if the provider is running
            ///     on a 64-bit system.
            /// </summary>
